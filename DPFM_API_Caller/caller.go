...
func (c *DPFMAPICaller) generalDelete(
	...
	general.StorageLocation = input.General.StorageLocation
	general.StorageBin = input.General.StorageBin
	general.IsMarkedForDeletion = input.General.IsMarkedForDeletion
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": general, "function": "StorageBinGeneral", "runtime_session_id": sessionID})
	if err != nil {
